...
export type ArtifactType = 
  ...
  | 'system_validation_evidence'   // Single-system evidence for "Why?" responses (Validation First)
  ...
  // NOTE: system_validation_evidence is ALWAYS injected BEFORE AI response (Validation First Doctrine)
