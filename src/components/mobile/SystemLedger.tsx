...
export function SystemLedger({
  ...
  return <section className="w-full">
      ...
      <div className="flex flex-col">
        ...
        return <div key={system.systemId} className="flex justify-between items-center py-4 border-b border-habitta-stone/10 last:border-0">
